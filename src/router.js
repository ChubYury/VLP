...
const CoachContact = defineAsyncComponent(() => import('./pages/requests/CoachContact.vue'));
const RequestPage = defineAsyncComponent(() => import('./pages/requests/RequestPage.vue'));
